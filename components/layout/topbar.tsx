            ...
            <div className="flex-1 max-w-xl">
                <div className="relative group">
                    ...
                    <input
                        ...
                        className="w-full pl-11 pr-4 py-2.5 bg-gray-50 border-none rounded-xl text-sm focus:ring-2 focus:ring-[#5347CE]/20 focus:bg-white transition-all placeholder:text-gray-400"
                    />
